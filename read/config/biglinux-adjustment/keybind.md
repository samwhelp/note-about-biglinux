...
這篇的根據，是採用「[客製的設定](https://samwhelp.github.io/note-about-biglinux/read/config/biglinux-adjustment.html)」，

請參考「[我的設定檔: ~/.config/kglobalshortcutsrc](https://github.com/samwhelp/biglinux-adjustment/tree/main/prototype/de/kde/part/kde-keybind-main/config/kde/kglobalshortcutsrc)」。
